setwd("/Users/yuikikondo/Desktop/Github_code/protostome_lifespan_prediction_model/02_model_comparison/02_03_BUSCO_Miniprot_gene_average_trinucleotide_excluding_5spp_1000folds_seed1_alpha1/only_exon")
