...
# Load the CSV file
df = pd.read_csv("/home/y-kondo/protostome_lifespan_model/BUSCO_seq_directory/up_downstreams_range_refined_exon_intron_separated_including_dup/gene_region_separated_sequences_all_hit_buscos/trinucleotide_count_excluding_5spp/elasticnet_all_gene_average/filtered_species_with_zero_lifecycle_6_categories_rearranged_trinuc_rates_Github_check.csv")
...
final_df.to_csv("filtered_species_with_zero_lifecycle_6_categories_each_region_wide_trinuc_rates_Github_check.csv", index=False)

print("Reshaped file saved as filtered_species_with_zero_lifecycle_6_categories_each_region_wide_trinuc_rates_Github_check.csv")
