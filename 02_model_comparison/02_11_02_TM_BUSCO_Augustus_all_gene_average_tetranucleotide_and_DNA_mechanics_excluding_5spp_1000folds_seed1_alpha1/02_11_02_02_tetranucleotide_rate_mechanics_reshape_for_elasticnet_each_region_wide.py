...
# Load the CSV file
df = pd.read_csv("/home/y-kondo/protostome_lifespan_model_augustus/Augustus_seq_directory/up_downstreams_range_refined_exon_intron_separated/di_tri_tetra_mechanics_Github_check/elasticnet_all_gene_average_tetra_rate_and_30_mechanics/filtered_species_with_zero_lifecycle_6_categories_rearranged_di_tri_tetra_mechanics.csv")
