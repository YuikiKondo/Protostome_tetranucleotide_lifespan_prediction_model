...
# Load the CSV file
df = pd.read_csv("/home/y-kondo/protostome_lifespan_model/BUSCO_seq_directory/up_downstreams_range_refined_exon_intron_separated_including_dup/gene_region_separated_sequences_all_hit_buscos/tetranucleotide_count/elasticnet_all_genes_average/filtered_species_with_zero_lifecycle_6_categories_rearranged_tetranuc_rates_Github_check.csv")
