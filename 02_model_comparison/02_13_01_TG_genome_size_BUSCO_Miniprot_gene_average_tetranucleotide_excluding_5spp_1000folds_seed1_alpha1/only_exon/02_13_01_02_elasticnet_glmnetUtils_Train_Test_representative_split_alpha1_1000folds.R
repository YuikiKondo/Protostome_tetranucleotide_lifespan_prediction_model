setwd("/Users/yuikikondo/Desktop/Github_code/protostome_lifespan_prediction_model/02_model_comparison/02_13_01_TG_genome_size_BUSCO_Miniprot_gene_average_tetranucleotide_excluding_5spp_1000folds_seed1_alpha1/only_exon")
...
data_definitive_test <- data_definitive_test %>%
  select(Organism.Name, Lifespan, log_lifespan, ln_Genome_size, contains("_exon"))
