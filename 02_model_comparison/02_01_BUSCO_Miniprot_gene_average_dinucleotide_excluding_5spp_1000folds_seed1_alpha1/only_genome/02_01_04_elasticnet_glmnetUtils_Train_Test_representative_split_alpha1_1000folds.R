setwd("/Users/yuikikondo/Desktop/Github_code/protostome_lifespan_prediction_model/02_model_comparison/02_01_BUSCO_Miniprot_gene_average_dinucleotide_excluding_5spp_1000folds_seed1_alpha1/only_genome")
