setwd("/Users/yuikikondo/Desktop/Github_code/protostome_lifespan_prediction_model/02_model_comparison/02_13_02_TG_genome_size_Augustus_all_gene_average_tetranucleotide_excluding_5spp_1000folds_seed1_alpha1/only_four_genic_regions")
...
data <- read.csv("filtered_species_with_zero_lifecycle_6_categories_each_region_wide_augustus_all_gene_tetranuc_rates_with_genome_size_Github_check.csv", header = TRUE)
...
data_definitive_test <- data_definitive_test %>%
  select(Organism.Name, Lifespan, log_lifespan, ln_Genome_size, contains("_downstream2"), contains("_upstream2"), contains("_exon"), contains("_intron"))
