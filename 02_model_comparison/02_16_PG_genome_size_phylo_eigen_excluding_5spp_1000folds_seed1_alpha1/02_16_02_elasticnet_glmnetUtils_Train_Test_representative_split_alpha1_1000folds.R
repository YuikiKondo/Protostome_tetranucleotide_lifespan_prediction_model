setwd("/Users/yuikikondo/Desktop/Github_code/protostome_lifespan_prediction_model/02_model_comparison/02_16_PG_genome_size_phylo_eigen_excluding_5spp_1000folds_seed1_alpha1")

# Feature_Name: eigenvector (e.g., "eigenvector_1", "eigenvector_2") and ln_Genome_size
...
data <- read.csv("phylo_eigenvectors_with_lifespan_with_genome_size.csv", header = TRUE)
...
data_definitive_test <- data_definitive_test %>%
  select(Organism.Name, Lifespan, log_lifespan, ln_Genome_size, contains("eigenvector"))
