setwd("/Users/yuikikondo/Desktop/Github_code/protostome_lifespan_prediction_model/02_02_Augustus_all_gene_average_trinucleotide_excluding_5spp_100folds_seed1")
...
data <- read_csv("filtered_species_with_zero_lifecycle_6_categories_each_region_wide_augustus_all_gene_trinuc_rates_Github_check.csv")
