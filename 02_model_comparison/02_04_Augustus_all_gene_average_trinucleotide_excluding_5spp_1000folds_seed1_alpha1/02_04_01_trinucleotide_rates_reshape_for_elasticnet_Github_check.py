...
# Load the CSV file
df = pd.read_csv('/home/y-kondo/protostome_lifespan_model_augustus/Augustus_seq_directory/up_downstreams_range_refined_exon_intron_separated/trinucleotide_count/filtered_species_with_zero_lifecycle_6_categories_Github_check.csv')
...
print("Filtered and rearranged data saved as 'filtered_species_with_zero_lifecycle_6_categories_rearranged_augustus_all_gene_trinuc_rates_Github_check.csv'")
