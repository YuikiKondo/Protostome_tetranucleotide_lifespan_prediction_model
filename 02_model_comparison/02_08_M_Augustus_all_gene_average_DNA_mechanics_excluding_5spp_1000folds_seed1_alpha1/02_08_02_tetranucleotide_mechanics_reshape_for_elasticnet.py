...
# Load the CSV file
df = pd.read_csv('/home/y-kondo/protostome_lifespan_model_augustus/Augustus_seq_directory/up_downstreams_range_refined_exon_intron_separated/di_tri_tetra_mechanics_Github_check/filtered_species_with_all_indexes_di_tri_tetra_combined_Github_check.csv')
...
df_filtered.to_csv('/home/y-kondo/protostome_lifespan_model_augustus/Augustus_seq_directory/up_downstreams_range_refined_exon_intron_separated/di_tri_tetra_mechanics_Github_check/elasticnet_all_gene_average/filtered_species_with_zero_lifecycle_6_categories_rearranged_di_tri_tetra_mechanics.csv', index=False)
