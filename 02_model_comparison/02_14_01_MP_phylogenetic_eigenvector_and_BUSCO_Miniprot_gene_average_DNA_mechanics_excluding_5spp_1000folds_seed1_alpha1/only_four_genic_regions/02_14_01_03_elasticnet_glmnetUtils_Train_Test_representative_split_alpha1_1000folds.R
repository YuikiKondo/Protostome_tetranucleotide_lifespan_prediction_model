setwd("/Users/yuikikondo/Desktop/Github_code/protostome_lifespan_prediction_model/02_model_comparison/02_14_01_MP_phylogenetic_eigenvector_and_BUSCO_Miniprot_gene_average_DNA_mechanics_excluding_5spp_1000folds_seed1_alpha1/only_four_genic_regions")
...
data <- read.csv("filtered_species_with_zero_lifecycle_6_categories_each_region_wide_di_tri_tetra_mechanics_with_eigenvectors.csv", header = TRUE)
