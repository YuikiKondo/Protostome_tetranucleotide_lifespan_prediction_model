...
# Load the CSV file
df = pd.read_csv("/home/y-kondo/protostome_lifespan_model_augustus/Augustus_seq_directory/up_downstreams_range_refined_exon_intron_separated/tetranucleotide_count/elasticnet_all_gene_average_Github_check/filtered_species_with_zero_lifecycle_6_categories_rearranged_augustus_all_gene_tetranuc_rates_Github_check.csv")
...
final_df.to_csv("filtered_species_with_zero_lifecycle_6_categories_each_region_wide_augustus_all_gene_tetranuc_rates_Github_check.csv", index=False)

print("Reshaped file saved as filtered_species_with_zero_lifecycle_6_categories_each_region_wide_augustus_all_gene_tetranuc_rates_Github_check.csv")
