setwd("/Users/yuikikondo/Desktop/Github_code/protostome_lifespan_prediction_model/02_model_comparison/02_17_01_TMP_phylogenetic_eigenvector_and_BUSCO_Miniprot_gene_average_tetranucleotide_and_DNA_mechanics_excluding_5spp_1000folds_seed1_alpha1/only_upstream")
...
data_definitive_test <- data_definitive_test %>%
  select(Organism.Name, Lifespan, log_lifespan, contains("_upstream2"), contains("eigenvector"))
