setwd("/Users/yuikikondo/Desktop/Github_code/protostome_lifespan_prediction_model/02_model_comparison/02_17_01_TMP_phylogenetic_eigenvector_and_BUSCO_Miniprot_gene_average_tetranucleotide_and_DNA_mechanics_excluding_5spp_1000folds_seed1_alpha1/only_four_genic_regions")
...
data <- read.csv("filtered_species_with_zero_lifecycle_6_categories_each_region_wide_tetra_rate_and_di_tri_tetra_mechanics_with_eigenvectors.csv", header = TRUE)
...
data_definitive_test <- data_definitive_test %>%
  select(Organism.Name, Lifespan, log_lifespan, contains("_downstream2"), contains("_upstream2"), contains("_exon"), contains("_intron"), contains("eigenvector"))
