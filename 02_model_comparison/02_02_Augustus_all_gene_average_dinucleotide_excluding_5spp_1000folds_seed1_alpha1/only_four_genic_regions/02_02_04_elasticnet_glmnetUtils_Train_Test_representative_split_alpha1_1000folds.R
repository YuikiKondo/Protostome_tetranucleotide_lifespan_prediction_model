setwd("/Users/yuikikondo/Desktop/Github_code/protostome_lifespan_prediction_model/02_model_comparison/02_02_Augustus_all_gene_average_dinucleotide_excluding_5spp_1000folds_seed1_alpha1/only_four_genic_regions")
...
data <- read.csv("filtered_species_with_zero_lifecycle_6_categories_each_region_wide_augustus_all_gene_dinuc_rates_Github_check.csv", header = TRUE)
