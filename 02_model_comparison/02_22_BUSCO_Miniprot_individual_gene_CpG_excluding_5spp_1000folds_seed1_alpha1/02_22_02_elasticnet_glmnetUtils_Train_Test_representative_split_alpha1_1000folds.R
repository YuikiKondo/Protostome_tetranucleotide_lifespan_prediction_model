setwd("/Users/yuikikondo/Desktop/Github_code/protostome_lifespan_prediction_model/02_model_comparison/02_22_BUSCO_Miniprot_individual_gene_CpG_excluding_5spp_1000folds_seed1_alpha1")
...
data <- read.csv("filtered_species_with_zero_lifecycle_6_categories_individual_BUSCO_CpG_Github_check.csv", header = TRUE)
