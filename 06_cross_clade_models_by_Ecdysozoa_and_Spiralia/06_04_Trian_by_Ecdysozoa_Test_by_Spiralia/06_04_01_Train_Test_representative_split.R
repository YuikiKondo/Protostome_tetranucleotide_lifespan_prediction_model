...
test_data <- data %>% filter(Phylum %in% spiralia_phyla)
train_data <- data %>% filter(Phylum %in% ecdysozoa_phyla)
...
cat("Train (Ecdysozoa):", nrow(train_data), "\n")
cat("Test (Spiralia):", nrow(test_data), "\n")
